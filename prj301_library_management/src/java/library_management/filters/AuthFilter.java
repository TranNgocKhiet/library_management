 ...
 */
package library_management.filters;
...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (path.equals(req.getContextPath() + "/")
                || path.contains("LoginController")
                || path.contains("RegisterController")
                || path.contains("login.jsp")
                || path.contains("register.jsp")
                || path.contains("SearchController")
                || path.contains("/css/")
                || path.contains("/js/")
                || path.contains("/images/")
                || path.contains("/jpg/")
                || path.contains("HomeController")) {
